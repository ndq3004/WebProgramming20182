...
<body class="bg-dark">
  ...
  <div class="container">
     <nav class="navbar navbar-expand navbar-dark bg-dark static-top password"> <!-- header -->
      ...
      <a class="navbar-brand mr-1" href="">
        <img src="./register_files/logo.png" alt="" class="logo">
        ...
        <form action="register" method="post" class="beta-form-checkout">
          ...
          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-6">
                <div class="form-label-group">
                  <input type="password" id="confirmPassword" class="form-control" placeholder="Confirm password" required="required" autofocus="autofocus">
                  <label for="confirmPassword">Confirm password</label>
                </div>
              </div>
            </div>
          </div>
          <a class="btn btn-primary btn-block" href="file:///D:/web_btl/WebProgramming20182/public/views/login.html">Register</a>
        </form>
  ...
  <script src="./register_files/jquery.min.js.tải xuống"></script>
  <script src="./register_files/bootstrap.bundle.min.js.tải xuống"></script>

  <!-- Core plugin JavaScript-->
  <script src="./register_files/jquery.easing.min.js.tải xuống"></script>
  <script src="./register_files/script.js.tải xuống" type="text/javascript" charset="utf-8" async="" defer=""></script>
